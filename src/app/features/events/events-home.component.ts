        ...
        <div class="flex flex-col sm:flex-row items-stretch gap-3">
          ...
          >
            ...
            <p class="text-sm font-medium text-surface-100">
              {{ 'events.home.step1_title' | translate }}
            </p>
          ...
          >
            ...
            <p class="text-sm font-medium text-surface-100">
              {{ 'events.home.step2_title' | translate }}
            </p>
          ...
          >
            ...
            <p class="text-sm font-medium text-surface-100">
              {{ 'events.home.step3_title' | translate }}
            </p>
          ...
          <div class="flex-1 rounded-lg border border-green-600/30 bg-green-500/10 p-4 text-center">
            ...
            <p class="text-sm font-medium text-surface-100">
              {{ 'events.home.step4_title' | translate }}
            </p>
        ...
        <div class="card">
          ...
          <ul class="space-y-3">
            <li class="flex items-start gap-3">
              <span
                class="shrink-0 mt-0.5 h-6 w-6 rounded bg-cyan-500/15 flex items-center justify-center text-xs font-bold text-cyan-400"
                >Go</span
              >
            ...
            <li class="flex items-start gap-3">
              <span
                class="shrink-0 mt-0.5 h-6 w-6 rounded bg-red-500/15 flex items-center justify-center"
              >
                <svg
              ...
              <span class="text-sm text-surface-300">{{
                'events.home.tech_redis' | translate
              }}</span>
            </li>
            <li class="flex items-start gap-3">
              <span
            ...
            <li class="flex items-start gap-3">
              <span
                class="shrink-0 mt-0.5 h-6 w-6 rounded bg-surface-600 flex items-center justify-center"
              >
                <svg
                  class="h-3.5 w-3.5 text-surface-300"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
